...
class CafeteriaApiView(APIView):
    ...
    def post(self, request, *args, **kwags):
        ...
        data = {
            ...
            'nombre_del_producto': request.data.get('nombre_del_producto'),
            'precio' : request.data.get('precio'),
            'image' : request.data.get('image'),
            'fecha_de_vencimiento' : request.data.get('fecha_de_vencimiento'),
            'fecha_de_expedicion' : request.data.get('fecha_de_expedicion'),
        }
